...
namespace Frosting\IService\EventDispatcher\Tests;
...
abstract class EventDispatcherServiceTest extends \PHPUnit_Framework_TestCase 
{
  ...
  /**
   * @return \Frosting\IService\EventDispatcher\IEventDispatcherService
   */
  ...
  public function testDispatch() 
  {
    ...
    $this->assertInstanceOf('Frosting\IService\EventDispatcher\IEvent', $this->dispatcher->dispatch('noevent'));
    $this->assertInstanceOf('Frosting\IService\EventDispatcher\IEvent', $this->dispatcher->dispatch(self::preFoo));
  }
