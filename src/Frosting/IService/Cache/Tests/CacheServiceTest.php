...
namespace Frosting\IService\Cache\Tests;
...
abstract class CacheServiceTest extends \PHPUnit_Framework_TestCase
{
  ...
  /**
   * @return \Frosting\IService\Cache\ICacheService
   */
  ...
  private function loadCacheService()
  {
    if(is_null($this->cacheService)) {
      ...
      $this->assertInstanceOf('\Frosting\IService\Cache\ICacheService', $this->cacheService);
    }
  ...
  public function testGetCategory()
  {
    ...
    $this->assertInstanceOf('\Frosting\IService\Cache\ICacheCategory', $category);
