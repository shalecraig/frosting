...
namespace Frosting\BusinessRuleEngine\Tests;
...
class RulesTest extends \PHPUnit_Framework_TestCase
{
  ...
  public function setUp()
  {
    $this->businessRuleEngine = BusinessRuleEngine::factory(
      array(
        ...
        'services' => array(
          'clock' => array('configuration' => array('now' => '2000-01-01 00:00:00'))
        )
      )
    );
  }
  ...
  public function testDate($ruleComposition, $expected, DateTime $dateTime = null)
  {
    ...
    $this->assertSame(
      $expected,
      $this->businessRuleEngine->check($ruleComposition,"default",$contexParameters)
    );
  }
