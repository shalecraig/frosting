...
namespace Frosting\BusinessRule\Tests;

use Frosting\Framework\Clock;
use Frosting\BusinessRule\Rule\DateBefore;
use DateTime;

/**
 * Description of RuleDateBeforeTest
 *
 * @author Martin
 */
class RuleDateBeforeTest extends \PHPUnit_Framework_TestCase
{
  /**
   * @var \Frosting\Framework\Clock 
   */
  private $clock;
  ...
  public function provide()
  {
    ...
    return array(
      array("2013-04-04",null,true),
      array("1998-04-04",null,false),
