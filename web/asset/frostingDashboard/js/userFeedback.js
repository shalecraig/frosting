...
/**
 *       if(!response.data.error && !noConfirmation) {
        App.Frosting.get('mainContainer').prepend('<div class="alert fade in alert-success"><a class="close" data-dismiss="alert">×</a>The action "' + this.name + '" was executed properly.</div>');
      }
 */