...
Frosting.Requests = Backbone.Model.extend({
    ...
    request: function(url, options) {
        ...
        var request = new Frosting.Request({options:options,url:url,controller:this.get('controller')});
        ...
        $.ajax({ 
            ...
            success: function(data) {
              var response = this.get('controller').getResponseAdapter().createResponse(data).setRequest(request);
