...
Frosting.Controller = Backbone.Model.extend({ 
    ...
    initialize: function(options) {
        this.requests = new Frosting.Requests({controller:this});
    ...
    getFactory: function() {
      if(this.factory == null) {
        this.factory = new Frosting.Factories.CompositeFactory({controller:this});
        this.factory.appendFactory(new Frosting.Factories.Default({controller:this}));
      }
